...
from brand_parser import BottegaVenetaParser, GucciParser, FendiParser, BallyParser, StellaProductParser, \
    ...
    JacquemusParser, LouboutinParser, PalmAngelsParser, MooseKnucklesParser, AcneStudiosParser, \
    TheRowParser, ManoloBlahnikParser, GianvitoRossiParser, MiuMiuParser, BirkenstockParser, AquazzuraParser, \
    OffWhiteProductParser, TomFordProductParser, LoeweParser,ValentinoProductParser,Chloe_Parser
...
#directory_path = r'C:\Users\NikPopov\Desktop\Sam_Files\Product_Scrapers\site-parsing\internal_html\chloe'
...
#Chloe Start
#categories = ['llrtw','shs','ccssslg','ccssrs','chlsnglssssll','frgrncs','llchldrnswr',"llbgs",'sls','gftfrhr']
#ChloeParser=ChloeProductParser()
#ChloeParser.process_categories(categories)
#Chloe End

#Valentino Start
#categories = ['women/ready-to-wear','women/bags']
#ValentinoParser=ValentinoProductParser()
#ValentinoParser.process_categories(categories)
#Valentino End